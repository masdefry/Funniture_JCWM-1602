            ...
            <div className="container" style={{marginTop: '50px'}}>
                ...
                <div className="row mt-4">
                    <div className="row col-7">
                        <div className="col-12 row mb-4 p-3 shadow">
                            <h6 className="col-12 pb-2 border-bottom">Alamat Pengiriman</h6>
                            <br style={{border: '3px solid black', width: '300px'}} />
                            <div className="col-12">
                                {/* Hasil Form Pengisian Alamat */}
                                <p className="text-secondary mb-2">Alamat belum ada</p>
                                <button className="btn btn-light border rounded-pill font-weight-bold text-secondary v-font-16" onClick={() => {this.setState({showModal: true})}}>
                                    <span className="">Tambah Alamat</span>
                                </button>
                            </div>
                            <br style={{border: '3px solid black', width: '300px'}} />
                        </div>
                        ...
                        <div className="card shadow px-4 py-3">
                            ...
                            <div className="my-2 py-3 border-bottom">
                                <div className="d-flex justify-content-between">
                                    <span className="card-text">Total Tagihan</span>
                                    <span className="card-text">Rp.2.190.000</span>
                                </div>
                                <div className="d-flex justify-content-between">
                                    <span className="card-text">Biaya Layanan</span>
                                    <span className="card-text">Rp.9.000</span>
                                </div>
                            </div>
                            <div className="mt-1 d-flex justify-content-between align-items-end">
                                    <div>
                                        <p className="mb-1">Total Bayar</p>
                                        <h6 className="my-0">Rp.2.199.000</h6>
                                    </div>
